...
Future<void> showToast({required int errorType, required String message}) async{
  if (errorType == 0) {
...
String? welcome = CacheHelper.getData(key: CacheKeys.welcome);
String? googleClientIdIos =
    "519171617357-ea5stt0mq1vavf89nvj9e15rgnc0ikjp.apps.googleusercontent.com";
String? googleClientIdAndroid =
    "519171617357-gb5jkffo2fpdek02j89souen5balhfos.apps.googleusercontent.com";
...
String? initialLocale =
    CacheHelper.getData(key: CacheKeys.initialLocale) ?? "ar";
Size preferredSize = AppBar().preferredSize;

String jjj = "24.715589, 46.636249";
