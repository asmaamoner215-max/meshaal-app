...
class DoctorArrivesScreen extends StatefulWidget {
  const DoctorArrivesScreen({super.key});

  @override
  State<DoctorArrivesScreen> createState() => _DoctorArrivesScreenState();
}

class _DoctorArrivesScreenState extends State<DoctorArrivesScreen> {
  @override
  void initState() {
    super.initState();
    getCurrentMarker();
